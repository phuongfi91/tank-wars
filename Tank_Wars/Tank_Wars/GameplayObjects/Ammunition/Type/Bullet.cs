	...
	public class Bullet : Ammunition
	{
		...
		protected override void CreateImpact()
		{
			...
			GameplayScreen.EffectList.Add
				...
				new CollisionEffect
					(
					this.GameplayScreen, GameplayScreen.Content.Texture.BulletImpactSheet, CurrentWorldPosition, 0,
					new Point(16, 16), new Point(8, 5)
					)
				);
			Audio.Play
				(GameplayScreen.Content.Audio.BulletImpact, this.CurrentWorldPosition,
